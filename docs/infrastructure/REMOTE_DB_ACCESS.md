...
mysql -h 127.0.0.1 -P 3307 -u root -p__REDACTED_ROOT_PW__ okhwadang
...
```bash
# 로컬 DB에 seed 적용
mysql -h 127.0.0.1 -P 3307 -u root -p__REDACTED_ROOT_PW__ okhwadang < backend/src/database/seeds/okhwadang-seed.sql
