...
export class SeedArchivesAndCollections1776900000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await query(`
      ...
      ('주형호', 'Zhu Xing', '주형호 명인', 'Zhu Xing Master', '복건성 의흥', 'Yixing, Fuchun', '40년 이상의 경험으로 전통 주형호를 빚어 온 명인입니다. 대나무 마디의 생명감과 곧은 선을 형상에 담아내는 독자적인 기법을 보유하고 있습니다.', 'Master with over 40 years of experience crafting traditional Zhuxing teapots. Holds a unique technique of capturing bamboo vitality in form.', '주형호, 대나무 마디 표현', 'Zhuxing teapots, bamboo joint expression', 'https://okhwadang-images-978581199241-ap-northeast-2-an.s3.ap-northeast-2.amazonaws.com/artist-zhuxing.png', '/products?categoryId=20', 1, 1),
      ('석표호', 'Shi Biao', '석표호 명인', 'Shi Biao Master', '복건성 의흥', 'Yixing, Fuchun', '석표호 특유의 삼각 구도와 안정감, 힘 있는 선을 섬세하게 표현하는 실력파 명인입니다. 삼각 뚜껑 손잡이 표현에 깊은 조형 이해를 갖추고 있습니다.', 'A skilled master expressing Shibiao triangular stability and powerful lines. Pioneer of triangular lid knob expression.', '석표호, 삼각 형태', 'Shibiao teapots, triangular form', 'https://okhwadang-images-978581199241-ap-northeast-2-an.s3.ap-northeast-2.amazonaws.com/artist-shibiao.png', '/products?categoryId=21', 2, 1),
      ('서시호', 'Xi Shi', '서시호 명인', 'Xi Shi Master', '복건성 의흥', 'Yixing, Fuchun', '서시호의 부드럽고 우아한 곡선을 조화롭게 담아내는 명인입니다. 손에 감기는 편안한 사용감과 균형 잡힌 비례로 입문자에게도 추천하기 좋은 작품을 선보입니다.', 'Top master capturing feminine elegant curves in Seoshi teapots. Known for excellent usability, recommended for beginners.', '서시호, 부드러운 곡선', 'Seoshi teapots, smooth curves', 'https://okhwadang-images-978581199241-ap-northeast-2-an.s3.ap-northeast-2.amazonaws.com/artist-seoshi.png', '/products?categoryId=22', 3, 1)
    `);
