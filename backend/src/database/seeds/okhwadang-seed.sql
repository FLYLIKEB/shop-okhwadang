...
(4,  11, '옥화당 자사 편평호 200ml',
 'zǐshā-biānpíng-200',
 '의흥(宜興) 정통 자사니로 성형한 편평호. 납작한 원판 형태에 부드러운 곡선이 흐르며, 자사 특유의 깊은 자주빛이 우리는 보이차와 완벽하게 어울립니다. 200ml 용량으로 3~4인 소규모 차회에 알맞습니다.',
 '의흥 자사 · 편평형 · 200ml',
...
-- 입문 세트: 자사호 니로 선택
(19, '자사호 니로', '자사 (기본)', 0, 4, 0),
(19, '자사호 니로', '단니 (+20,000)', 20000, 2, 1),
(19, '자사호 니로', '주니 (+50,000)', 50000, 1, 2);
