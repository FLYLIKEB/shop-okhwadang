...
('Danji', '단니', '#D4A574', '의흥 황룡산', '황토계열의 단단한 니료로, 밝은 황금빛을 띱니다. 은은한 향과 부드러운 맛을 표현하는 데 적합합니다.', '["황금빛","황토질","경도 높음","은은한 향","부드러운 맛"]', '/products?attrs=clay_type:danji', 2, 1),
('Jani', '자니', '#2F4F4F', '의흥 황룡산', '청자질의 대표 니료로, 청록색 내지 암청색을 띱니다. 깊은 향과 시원한 맛을 자랑합니다.', '["청록색~암청색","청자질","투기성 우수","깊은 향","시원한 맛"]', '/products?attrs=clay_type:jani', 3, 1),
('Heugni', '흑니', '#1C1C1C', '의흥 황룡산', '흑색 도자기 전용 니료로, 검은색을 띱니다. 떫은맛을 줄이고 깊은 맛을내는 특성이 있습니다.', '["검은색","흑토질","세련된 맛","떫은맛 감소","깊은 맛"]', '/products?attrs=clay_type:heugni', 4, 1),
('Cheongsu', '청수니', '#4682B4', '장쑤성 이싱', '청수(정선) 지역 특유의 청백색 니료입니다. 산뜻한 맛과 깨끗한 향이 특징입니다.', '["청백색","청수질","산뜻한 맛","깨끗한 향","Blanc de Chine"]', '/products?attrs=clay_type:cheongsu', 5, 1),
('Nokni', '녹니', '#556B2F', '운남성''', '녹토계열의 독특한 니료로, 녹색기를 띱니다. 건강과 풍미를 동시에 생각하는 이들에게 사랑받습니다.', '["녹토질","녹색기","건강 지향","톡쏘는 맛","특유의 신선함"]', '/products?attrs=clay_type:nokni', 6, 1);
