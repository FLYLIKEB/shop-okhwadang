...
INSERT INTO `product_options` VALUES (1,1,'포장','일반 포장',0.00,3,0),(2,1,'포장','전통 목함 선물포장',30000.00,2,1),(3,4,'포장','일반 포장',0.00,5,0),(4,4,'포장','전통 목함 선물포장',30000.00,3,1),(5,11,'보관','기본 포장',0.00,15,0),(6,11,'보관','전통 죽지 보관함 포함',15000.00,5,1),(7,12,'보관','기본 포장',0.00,8,0),(8,12,'보관','전통 죽지 보관함 포함',15000.00,2,1),(9,19,'자사호 니료','자사 (기본)',0.00,4,0),(10,19,'자사호 니료','단니 (+20,000)',20000.00,2,1),(11,19,'자사호 니료','주니 (+50,000)',50000.00,1,2);
...
CREATE TABLE `collections` (
  ...
  `nameKo` varchar(100) DEFAULT NULL,
...
INSERT INTO `collections` VALUES
  (1,'clay','Zhu Ni','주니','#C1440E','붉은빛의 주니(朱泥)는 철분이 풍부해 소성 후 선명한 적색을 띱니다. 밀도가 높아 보이차의 향을 잘 살려줍니다.',NULL,'/products?categoryId=1',1,1,NOW(),NOW()),
  (2,'clay','Duan Ni','단니','#D4A96A','단니(段泥)는 황색 계열의 니료로 투기성이 좋아 차의 맛을 부드럽게 만들어줍니다.',NULL,'/products?categoryId=1',2,1,NOW(),NOW()),
  (3,'clay','Zi Ni','자니','#6B4F8C','자니(紫泥)는 자사호의 대표 니료로, 자주빛의 우아한 색감과 뛰어난 보온성이 특징입니다.',NULL,'/products?categoryId=1',3,1,NOW(),NOW()),
  (4,'clay','Hei Ni','흑니','#2C2C2C','흑니(黑泥)는 높은 온도에서 소성되어 깊은 흑색을 띠며, 내구성이 뛰어납니다.',NULL,'/products?categoryId=1',4,1,NOW(),NOW()),
  (5,'clay','Qing Shui Ni','청수니','#8B9E7A','청수니(靑水泥)는 청록빛의 희귀 니료로 차의 청향을 극대화합니다.',NULL,'/products?categoryId=1',5,1,NOW(),NOW()),
  (6,'clay','Lv Ni','녹니','#5A7A4E','녹니(綠泥)는 녹색 계열의 희귀 니료로 고급 자사호에 사용됩니다.',NULL,'/products?categoryId=1',6,1,NOW(),NOW()),
  (7,'shape','Xi Shi','서시','#8B7355','서시호(西施壺)는 고대 미인 서시를 본떠 만든 둥근 형태로, 부드러운 곡선이 특징입니다.',NULL,'/products?categoryId=1',1,1,NOW(),NOW()),
  (8,'shape','Shi Piao','석표','#7A6648','석표호(石瓢壺)는 돌바가지 형태로 납작하고 안정적인 모양이 특징입니다.',NULL,'/products?categoryId=1',2,1,NOW(),NOW()),
  (9,'shape','Ren Wang','인왕','#6B5C42','인왕호(仁王壺)는 당당하고 넓은 어깨선이 특징인 전통 형태입니다.',NULL,'/products?categoryId=1',3,1,NOW(),NOW()),
  (10,'shape','De Zhong','덕종','#7D6E58','덕종호(德鐘壺)는 종 모양을 닮은 단정한 형태로 실용성이 높습니다.',NULL,'/products?categoryId=1',4,1,NOW(),NOW()),
  (11,'shape','Shui Ping','수평','#6A5C4A','수평호(水平壺)는 수평으로 납작한 형태로 공부차에 적합한 소형 자사호입니다.',NULL,'/products?categoryId=1',5,1,NOW(),NOW());
UNLOCK TABLES;

--
-- Table structure for table `nilo_types`
--

DROP TABLE IF EXISTS `nilo_types`;
...
LOCK TABLES `nilo_types` WRITE;
INSERT INTO `nilo_types` VALUES
  (1,'Zhu Ni','주니','#C1440E','강소성 의흥(宜興) 황룡산','붉은빛의 주니는 철분이 풍부하고 입자가 치밀합니다. 소성 수축률이 높아 제작이 어려우나 향기 보존력이 탁월합니다.','["높은 철분 함량","소성 후 선명한 적색","밀도가 높아 보향성 탁월","수축률 20% 이상"]','/products?categoryId=1',1,1,NOW(),NOW()),
  (2,'Duan Ni','단니','#D4A96A','강소성 의흥 황룡산 중층','황색 계열의 단니는 점토와 석영의 자연 혼합물입니다. 투기성이 좋아 차의 맛을 부드럽게 정돈해줍니다.','["황색~베이지 색상","투기성 우수","차 맛 정화 효과","소성 온도 1100~1180°C"]','/products?categoryId=1',2,1,NOW(),NOW()),
  (3,'Zi Ni','자니','#6B4F8C','강소성 의흥 황룡산 하층','자사호의 대표 니료. 자주빛의 우아한 색감과 뛰어난 보온성으로 가장 널리 사용됩니다.','["자주~보라색","보온성 탁월","사용할수록 광택 증가","소성 온도 1150~1200°C"]','/products?categoryId=1',3,1,NOW(),NOW()),
  (4,'Hei Ni','흑니','#2C2C2C','강소성 의흥 황룡산 심층','높은 온도에서 소성되어 깊은 흑색을 띠며 내구성이 뛰어납니다. 희귀성이 높습니다.','["심흑색","고온 소성(1200°C 이상)","내구성 최강","희귀 니료"]','/products?categoryId=1',4,1,NOW(),NOW()),
  (5,'Qing Shui Ni','청수니','#8B9E7A','강소성 의흥 청룡산','청록빛의 희귀 니료로 차의 청향을 극대화합니다. 생산량이 적어 수집 가치가 높습니다.','["청록빛 색상","청향 극대화","희귀 산지","수집 가치 높음"]','/products?categoryId=1',5,1,NOW(),NOW()),
  (6,'Lv Ni','녹니','#5A7A4E','강소성 의흥 녹색 광맥','녹색 계열의 희귀 니료로 자연산 녹색 광물이 혼합되어 있습니다. 고급 자사호에만 사용됩니다.','["자연 녹색","희귀 광맥 산출","고급 제품 한정","독특한 색감"]','/products?categoryId=1',6,1,NOW(),NOW());
UNLOCK TABLES;
...
INSERT INTO `process_steps` VALUES
  (1,1,'채굴 (採掘)','황룡산 광맥에서 원토 채취','의흥 황룡산의 특정 지층에서 자사 원토를 채굴합니다. 광맥의 깊이와 위치에 따라 니료의 종류와 품질이 결정됩니다. 숙련된 광부가 직접 선별하며 채굴합니다.',NOW(),NOW()),
  (2,2,'풍화·정제 (風化精製)','원토를 야외에서 1~3년 자연 풍화','채굴한 원토를 야외에 쌓아두고 햇빛·비·서리를 맞혀 자연 풍화시킵니다. 이 과정에서 불순물이 제거되고 점성이 좋아집니다. 최소 1년, 고급 니료는 3년 이상 풍화합니다.',NOW(),NOW()),
  (3,3,'분쇄·수비 (水飛)','물로 불순물 제거 후 니료 정선','풍화된 원토를 분쇄하고 물에 풀어 체로 걸러 불순물을 제거합니다. 입자 크기별로 분리하여 용도에 맞는 니료를 만듭니다.',NOW(),NOW()),
  (4,4,'성형 (成形)','손과 도구로 호형 빚기','정제된 니료로 자사호를 성형합니다. 물레를 사용하지 않고 호박(壺拍)과 같은 전통 도구를 사용해 손으로 직접 빚는 것이 자사호만의 특징입니다.',NOW(),NOW()),
  (5,5,'음건·수정 (陰乾修整)','그늘에서 천천히 건조 후 다듬기','성형된 자사호를 직사광선을 피해 그늘에서 천천히 건조합니다. 건조 중 균열이 생기지 않도록 관리하며, 마른 후 세부를 다듬고 낙관(落款)을 새깁니다.',NOW(),NOW()),
  (6,6,'소성 (燒成)','가마에서 고온 소성 (1100~1200°C)','건조된 자사호를 용요(龍窯) 또는 전기 가마에서 1100~1200°C로 소성합니다. 니료 종류에 따라 온도와 시간이 다르며, 이 과정에서 색상과 경도가 결정됩니다.',NOW(),NOW()),
  (7,7,'검수·양호 (養壺)','완성품 검수 및 차로 길들이기','소성된 자사호를 꼼꼼히 검수하고, 처음 사용 전 차를 우려 길들이는 양호(養壺) 과정을 거칩니다. 사용할수록 차의 유분이 스며들어 독특한 광택이 생깁니다.',NOW(),NOW());
UNLOCK TABLES;
...
INSERT INTO `artists` VALUES
  (1,'陳國良','국가급 공예미술대사','강소성 의흥','30년 이상 자사호를 제작해온 국가급 공예미술대사. 전통 서시호와 석표호를 현대적 감각으로 재해석하는 작업으로 유명합니다. 그의 작품은 차를 우릴수록 더욱 아름다워집니다.','서시호, 석표호 전문, 주니·자니 니료',NULL,'/products?categoryId=1',1,1,NOW(),NOW()),
  (2,'李惠芳','강소성 공예미술대사','강소성 의흥','20년 경력의 여성 자사호 장인. 섬세한 손길로 만들어지는 그녀의 수평호는 공부차 애호가들에게 특히 인기가 높습니다. 전통 기법 보존과 계승에 힘쓰고 있습니다.','수평호 전문, 단니·청수니 니료',NULL,'/products?categoryId=1',2,1,NOW(),NOW()),
  (3,'王志強','의흥 자사호 연구소 연구원','강소성 의흥','의흥 자사호 연구소에서 니료 연구와 성형 기법 개발을 담당하고 있습니다. 희귀 니료인 흑니와 녹니를 활용한 작품으로 주목받고 있으며, 실험적인 형태를 추구합니다.','흑니·녹니 전문, 현대적 형태 연구',NULL,'/products?categoryId=1',3,1,NOW(),NOW());
UNLOCK TABLES;
