...
const STATIC_RULES: StaticKeywordRule[] = [
  ...
  attribute('clay_type', 'danji', '단니', ['단니', '段泥', 'duanni'], 180),
  attribute('clay_type', 'junni', '주니', ['주니', '朱泥', 'zhuni'], 180),
  attribute('clay_type', 'hongni', '홍니', ['홍니', '紅泥', 'hongni'], 180),
  attribute('clay_type', 'jani', '자니', ['자니', '紫泥', 'zini'], 180),
  attribute('clay_type', 'heugni', '흑니', ['흑니', '黑泥'], 180),
  attribute('clay_type', 'nokni', '녹니', ['녹니', '綠泥', 'luni'], 170),
  ...
  attribute('teapot_shape', 'seoshi', '서시', ['서시', '西施', 'xishi'], 200),
  attribute('teapot_shape', 'seokpyo', '석표', ['석표', '石瓢', 'shipiao'], 200),
  attribute('teapot_shape', 'fanggu', '방고호', ['방고호', '방고', '仿古'], 200),
  attribute('teapot_shape', 'supeong', '수평', ['수평', '水平', 'shuiping'], 200),
